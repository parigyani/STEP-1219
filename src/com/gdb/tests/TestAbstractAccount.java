...
public class TestAbstractAccount {
    public static void main(String[] args) {
        ...
        AbstractAccount sa = new SavingsAccount(
            "SAV1001", "Rajesh Sharma", 28, 10000.0,
            "ACTIVE", "1234", 1000.0, 4.0
        );
        ...
        AbstractAccount ca = new CurrentAccount(
            "CUR1001", "Priya Patel", 34, 2000.0,
            "ACTIVE", "5678", 10000.0
        );
        ...
        AbstractAccount fda = new FixedDepositAccount(
            "FD1001", "Amit Kumar", 45, 50000.0,
            "ACTIVE", "1111", 12, 6.5
        );
